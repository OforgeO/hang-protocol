...
* @dev NOTE: THIS CONTRACT IS NOT USED WITHIN THE Hang PROTOCOL. It's an accessory contract used to reduce the number of calls
* towards the blockchain from the Hang backend.
**/
