...
/// - Owned by the Hang governance system, allowed to add sources for assets, replace them
...
contract ChainlinkProxyPriceProvider is IPriceOracleGetter, Ownable {
    ...
    /// @notice External function called by the Hang governance to set or replace sources of assets
    /// @param _assets The addresses of the assets
    /// @param _sources The address of the source of each asset
    ...
    /// - Callable only by the Hang governance
